...
function Kontakt() {
  return (
    <div className="ml-40 mr-40 w-full gap-5 relative min-h-screen "> 
      <div className="w-auto flex flex-row gap-20 ml-20"> 
        <button className="w-60 h-40 bg-slate-900 rounded-xl flex justify-center items-center mt-52">
          <a href="https://github.com/xBl0oM" className="flex items-center justify-center w-full h-full " target="_blank">
            <svg className="w-28 h-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 97.707 97.707" preserveAspectRatio="xMidYMid meet">
        ...
        <button className="w-60 h-40 bg-slate-900 rounded-xl flex justify-center items-center mt-52">
          <a href="https://www.linkedin.com/in/jan-frey-02246331b/" className="flex items-center justify-center w-full h-full" target="_blank" >
            <svg className="w-28 h-28" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
